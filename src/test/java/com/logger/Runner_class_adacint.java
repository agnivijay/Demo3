...
public class Runner_class_adacint extends Utilityclass {
	...
	public static Logger log=Logger.getLogger(Runner_class_adacint.class);
	public static PageObjectManager ob=new PageObjectManager(driver);
	public static void login_Btn() {
		
		implicit_wait(10);
		send_Keys(ob.getLp().getUsername(),"Ganeshvijay");
	...
	public static void main(String[] args) throws InterruptedException {
		...
		get_url("https://adactinhotelapp.com/SerchHotel");
		log.info("Success webbroswer launch");
		maximize();
		log.error("Success maximize");
		login_Btn();
		log.fatal("successfully login");
		searchhotel();
		bookhotel();
		//again_Search();
		//bookhotel();
